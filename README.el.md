...
Ο κώδικας της εφαρμογής διατίθεται υπό την άδεια MIT (βλ. `LICENSE`).

Το μοντέλο Gemma 3n παρέχεται από την Google υπό τους όρους χρήσης Gemma
(https://ai.google.dev/gemma/terms). Αν αναδιανείμετε το μοντέλο, πρέπει να
τηρήσετε αυτούς τους όρους.
