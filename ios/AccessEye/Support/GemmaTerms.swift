...
//  AccessEye
//
//  The complete official Gemma Terms of Use, embedded verbatim so the app can
//  show them offline. The Gemma license requires that every distribution be
//  accompanied by this text and by the notice "Gemma is provided under and
//  subject to the Gemma Terms of Use found at ai.google.dev/gemma/terms".
//  Shown from onboarding (before the first model download) and from
//  Settings > Licenses. Source: https://ai.google.dev/gemma/terms
//
...
enum GemmaTerms {
    ...
    /// The full, unmodified Gemma Terms of Use.
...
Gemma includes the following models:
...
Previous versions of these terms are available at ai.google.dev/gemma/terms-archive.
"""#
}
